...
object Api {
    ...
    fun body(vararg keysAndValues: Any?): Map<String, Any?> {
    ...
    fun msg(message: String?): Map<String, Any?> = body("message", message)

    fun fail(message: String?): Map<String, Any?> = body("success", false, "message", message)
